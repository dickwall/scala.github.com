...
- **SIPs**: Cloning and editing this repository is the way to introduce a new SIP, however
this is really just one step in a larger process and not the first. See more information on
the process of [submitting a SIP]({{ site.baseurl }}/sips/sip-submission.html).
